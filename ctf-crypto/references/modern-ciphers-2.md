...
*See also [ctf-web/auth-infra.md — Hash Length Extension Attack (ASIS CTF 2017)](../../ctf-web/references/auth-infra.md#hash-length-extension-attack-asis-ctf-2017) for the same primitive applied to a web auth token bypass.*
